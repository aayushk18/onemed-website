      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <button
              ...
              className="ml-4 px-6 py-2 bg-blue-400 hidden lg:flex text-white rounded-lg hover:bg-blue-500 font-medium"
            >
              Login
            </button>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden py-4 border-t">
            ...
            <button
              onClick={() =>{  window.location.href = 'https://onemedtutor.online/login';}} 
              className="block w-full mt-2 px-4 py-2 bg-blue-400 text-white rounded-lg font-medium"
            >
              Login
            </button>
          </div>
